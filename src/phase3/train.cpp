...
int main(int argc, char **argv)
{
    ...
    if (!weights_path.empty())
    {
        ...
        copyW(eng.w.w1, 256 * 3 * 9);
        copyW(eng.w.b1, 256);
        copyW(eng.w.w2, 128 * 256 * 9);
        copyW(eng.w.b2, 128);
        copyW(eng.w.w3, 128 * 128 * 9);
        copyW(eng.w.b3, 128);
        copyW(eng.w.w4, 256 * 128 * 9);
        copyW(eng.w.b4, 256);
        copyW(eng.w.w5, 3 * 256 * 9);
        copyW(eng.w.b5, 3);
    }
    else
    {
        ...
        init_weights_host(hw1);
        init_weights_host(hw2);
        init_weights_host(hw3);
        init_weights_host(hw4);
        init_weights_host(hw5);
